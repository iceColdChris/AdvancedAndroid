package com.example.cfahlin.advancedandroid.di;


import android.app.Activity;
import android.content.Context;

import com.example.cfahlin.advancedandroid.base.AdvancedApplication;
...
public class ActivityInjector {
	...
	static ActivityInjector get(Context context) {
		return ((AdvancedApplication)context.getApplicationContext()).getActivityInjector();
	}
}
